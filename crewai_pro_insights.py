...
pm_root_cause_analyst = Agent(role="root_cause_analyst", goal="An expert in root cause analysis in process mining.", backstory="Finds all the root causes of the performance issues.", llm=llm)

pm_root_cause_explainer = Agent(role="root_cause_explainer", goal="An expert in explaining process mining insights to non-technical people.", backstory="Very detailed analyst.", llm=llm)

pm_insights_grader = Agent(role="insights_grader", goal="An expert in giving a score to the process mining insights proposed by others.", backstory="Judge.", llm=llm)
